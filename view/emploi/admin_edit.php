...
<form class="form-horizontal" action="<?php echo router::url('admin/emploi/edit/'.$id);?>" method="post">
		<?php echo $this->form->input('id','hidden');?>
		<?php echo $this->form->input('title','Titre');?>
		<?php echo $this->form->input('subtitle','Sous-Titre');?>
		<?php echo $this->form->input('content','Contenu',array('type'=>'textarea','class'=>'input-xxlarge wysiwyg','rows'=>5));?>
		<?php echo $this->form->input('date','Date');?>
